...
class ADL_vit(nn.Module):
    ...
    def forward(self, input_):
        if not self.training:
            ...
            attention = torch.mean(input_, dim=2, keepdim=True)
    ...
    def _drop_mask(self, attention):
        ...
        thr_val = thr_val.view(b_size, 1, 1)
